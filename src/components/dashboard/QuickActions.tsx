            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {ACTIONS.map((action) => {
                    ...
                    return (
                        ...
                        >
                            <div className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-[#0f172a] group-hover:text-white transition-all">
