            ...
            <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <m.div
                        ...
                        className="max-w-2xl"
                    >
                        <m.div style={{ willChange: "transform, opacity" }} variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { type: "spring", bounce: 0.5, duration: 0.8 } } }} className="inline-flex items-center rounded-full border px-3 py-1 text-sm font-medium text-primary bg-primary/5 mb-6">
                            <span className="flex h-2 w-2 rounded-full bg-secondary mr-2"></span>
                            {tx(h.badge, lang)}
                        </m.div>

                        <m.h1 variants={{ hidden: { opacity: 1, y: 10 }, visible: { opacity: 1, y: 0 } }} className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-primary mb-6 leading-[1.1]">
                        ...
                        <m.p variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }} className="text-lg sm:text-xl text-muted-foreground mb-8 leading-relaxed max-w-xl">
                            <BouncyText text={tx(h.desc, lang)} type="word" />
                        </m.p>

                        <m.div style={{ willChange: "transform, opacity" }} variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { type: "spring", bounce: 0.5, duration: 0.8 } } }} className="flex flex-col sm:flex-row gap-4 mb-10">
                        ...
                        <m.div style={{ willChange: "transform, opacity" }} variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0, transition: { type: "spring", bounce: 0.4, duration: 0.8 } } }} className="flex items-center gap-6 text-sm text-muted-foreground">
