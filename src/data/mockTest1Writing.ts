...
export const mockTest1Writing: WritingTest = {
    id: "mt-1",
    ...
    tasks: [
        {
            ...
            prompt: `
                ...
                <div class="mt-8 p-4 bg-white border border-slate-200 rounded-lg shadow-sm">
                    <img src="/images/writing/water-filter.png" alt="Water-Filter Assembly Diagram" class="max-w-full h-auto mx-auto rounded-md" />
                </div>
            `
        },
        {
