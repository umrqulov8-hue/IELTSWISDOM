...
export const southPoleAdventurerData: ReadingTest = {
    id: "south-pole-adventurer",
    title: "South Pole Adventurer",
    passages: [
        {
            id: "south-pole-p1",
            title: "South Pole Adventurer",
            content: `
                <p class="mb-4">In the race to the South Pole, there was a Japanese team attempting to be first, led by heroic explorer Nobu Shirase</p>
                ...
                <p class="mb-4">But Shirase’s biggest challenge was time. Antarctica is only accessible by sea for a few weeks in summer and expeditions usually aimed to arrive in January or February. ‘Even with their determination and daring, our Japanese friends are running it rather fine,’ wrote local reporters.</p>
    ...
    questions: [
        // --- True / False / Not Given (1-8) ---
        {
            id: 1,
            type: "true-false",
            text: "Shirase's trip to the South Pole is well known to other explorers.",
        ...
        },
        {
            id: 3,
            type: "true-false",
            text: "Shirase's original ambition was to travel to the North Pole.",
            options: ["TRUE", "FALSE", "NOT GIVEN"],
        ...
        },
        {
            id: 7,
            type: "true-false",
            text: "A previous prime minister of Japan persuaded a scientist to go with Shirase.",
            options: ["TRUE", "FALSE", "NOT GIVEN"],
            correctAnswer: 2 // NOT GIVEN
        },
        {
        ...
        // --- Multiple Choice (9-13) ---
        {
            ...
            text: "When reporters in New Zealand met Shirase, they were",
            options: [
        ...
        },
        {
            id: 10,
            type: "multiple-choice",
            text: "What are we told about the captain of the Kainan Maru in the sixth paragraph?",
            options: [
                "A. He had given Shirase some poor advice.",
                "B. His skill in avoiding icebergs was exceptional.",
                "C. He was a former colleague of Shirase's.",
                "D. He was unhappy about the expedition's delays."
            ],
            correctAnswer: 1 // B
        },
        {
            id: 11,
            type: "multiple-choice",
            text: "After Shirase finally reached Antarctica he realised that",
            options: [
        ...
        },
        {
            id: 12,
            type: "multiple-choice",
            text: "What is the writer doing in the seventh paragraph?",
            options: [
                "A. explaining why Shirase's team failed to reach the pole.",
                "B. describing the conditions that Shirase's team had to endure.",
        ...
        },
        {
            id: 13,
            type: "multiple-choice",
            text: "What is the writer's main point in the final paragraph?",
            options: [
                "A. It was a greater achievement than Amundsen's.",
                "B. It was a remarkable achievement given the circumstances.",
