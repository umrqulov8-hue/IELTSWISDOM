      ...
      },
      {
        ...
        headers: [
          ...
          { key: 'Cross-Origin-Resource-Policy', value: 'cross-origin' },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' *.vercel-analytics.com va.vercel-scripts.com; style-src 'self' 'unsafe-inline' fonts.googleapis.com; font-src 'self' fonts.gstatic.com data:; img-src 'self' data: blob: *.supabase.co; media-src 'self' *.supabase.co blob:; connect-src 'self' *.supabase.co *.vercel-analytics.com va.vercel-scripts.com; frame-ancestors 'none';"
          },
        ],
      },
    ];
